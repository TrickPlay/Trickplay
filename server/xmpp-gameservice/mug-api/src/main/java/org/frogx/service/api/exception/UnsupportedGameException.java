...
public class UnsupportedGameException extends RuntimeException {
	...
	public UnsupportedGameException(String msg) {
		super(msg);
	}
	
	public UnsupportedGameException(String message, Throwable cause) {
		super(message, cause);
	}
	
	public UnsupportedGameException(Throwable cause) {
		super(cause);
	}
}
