 ...
 * Service Names
 */
#define AF_SERVICE_SPECIAL			"lg.service.special."				/* ¾ÈÁ×¾î¾ß ÇÏ´Â service */
#define AF_SERVICE_NORMAL			"lg.service.normal."				/* Á×¿©µµ µÇ´Â service */
#define AF_SERVICE_NORMAL_OFF		"lg.service.normal.off."			/* power off¶§¸¸ Á×ÀÌ´Â service */
...
#define AF_SERVICE_MEDIAFRAMEWORK	AF_SERVICE_NORMAL		AF_NAME_MEDIAFRAMEWORK
