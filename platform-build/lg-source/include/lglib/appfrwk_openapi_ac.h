...
HOA_STATUS_T		HOA_APP_RequestToFocusedApp (UINT64 AUID);
...
HOA_STATUS_T		HOA_APP_GetRunningAppCount (/*out*/UINT32 *pRunningAppNum);
HOA_STATUS_T		HOA_APP_GetFocusedAuid(UINT64 *pAUID);
HOA_STATUS_T		HOA_APP_GetFocusedIds(AM_APP_PROVIDER_T *pAppProvider, char **pszID);
HOA_STATUS_T		HOA_APP_CheckAppIsLoading (/*out*/BOOLEAN *pbAppLoading);
HOA_STATUS_T		HOA_APP_GetBackVideoType(AM_EXITCODE_T exitCode, AM_VIDEO_TYPE_T *pVideoType);
HOA_STATUS_T		HOA_APP_GetBackAppType(AM_EXITCODE_T exitCode, AM_APP_TYPE_T *pAppType);
HOA_STATUS_T		HOA_APP_SetResolution(UINT64 AUID, UINT16 x, UINT16 y, UINT16 width, UINT16 height, BOOLEAN bStretchToDisplay);
...
*/
HOA_STATUS_T		HOA_APP_CheckAppIsExisting (AM_APP_PROVIDER_T appProvider, /*out*/BOOLEAN *pAppExist);
/**
* Do Not Use this function!!
* This function will be deleted!!
*/
HOA_STATUS_T		HOA_APP_CheckFocusedApp (/*out*/BOOLEAN *pbAppExist);
#endif

//App List
HOA_STATUS_T		HOA_APP_GetAppCount (/*out*/UINT32 *pNumApps, AM_APPLIST_TYPE_T appListType, AM_CTXT_TYPE_T ctxtType);
...
HOA_STATUS_T		HOA_APP_GetPartialAppList (/*out*/AM_APP_INFO_T *appInfoArr, UINT32 startAppIndex, UINT32 numApps, AM_APPLIST_TYPE_T appListType, AM_CTXT_TYPE_T ctxtType);
...
//downloadedapp - 삭제/이동 가능 - HOA_APP_RequestToUninstallApp을 호출할 것 (TBD)
...
HOA_STATUS_T		HOA_APP_UpdateCardItem(UINT32 nCardID, UINT64* pAUIDArr, UINT32 nAUIDArrSize);
HOA_STATUS_T		HOA_APP_GetCardItemLists(UINT32 nCardID, /*out*/AM_APP_INFO_T** ppAppInfoArr, /*out*/UINT32* pnNumItems);
...
HOA_STATUS_T		HOA_APP_GetCardLists(/*out*/UINT32** ppnCardIdArr, /*out*/UINT32* pnCardNum);

/*Option*/
HOA_STATUS_T		HOA_APP_SetOption(AM_APP_OPT_T opt, SINT32 nValue);
