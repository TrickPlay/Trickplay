...
#ifdef EGL_EGLEXT_PROTOTYPES
EGLAPI EGLBoolean EGLAPIENTRY eglInitDriverMonitorBRCM(EGLDisplay display);
EGLAPI void EGLAPIENTRY eglDumpDriverMonitorBRCM(EGLDisplay display);
...
#endif /* EGL_EGLEXT_PROTOTYPES */
typedef void (EGLAPIENTRYP PFNEGLINITDRIVERMONITORBRCMPROC)(EGLDisplay display);
typedef void (EGLAPIENTRYP PFNEGLDUMPDRIVERMONITORBRCMPROC)(EGLDisplay display);
