...
typedef enum HOA_TVAPPS_APPLIST_TYPE
{
	...
	HOA_TVAPPS_APPLIST_LAUNCHER		= 0x02,				/**<Apps List - System */
	HOA_TVAPPS_APPLIST_FLASH			= 0x03,				/**<Apps List - System */
	HOA_TVAPPS_APPLIST_USB			= 0x04,				/**<Apps List - System */
...
{
	HOA_TV_GESTURE_POINT_TYPE_A			= 0,		/**< Pointer type A */
	HOA_TV_GESTURE_POINT_TYPE_B,						/**< Pointer type B */
	HOA_TV_GESTURE_POINT_TYPE_C,						/**< Pointer type C */
	HOA_TV_GESTURE_POINT_TYPE_D,						/**< Pointer type D */
	HOA_TV_GESTURE_POINT_TYPE_DRAG,					/**< Pointer type DRAG */
	
	HOA_TV_GESTURE_POINT_TYPE_LAST
...
//[sophia 10-06-18] add
HOA_UC_STATUS_T HOA_UC_GetInstalledAppListSize(UINT16 *pInstalledAppListSize,
...
HOA_STATUS_T HOA_TV_SetMotionRCCursorOn(BOOLEAN bCursorOn);
