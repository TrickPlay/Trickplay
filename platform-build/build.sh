...
GLIB_COMMANDS="glib_cv_stack_grows=no glib_cv_uscore=no ac_cv_func_posix_getpwuid_r=yes ac_cv_func_posix_getgrgid_r=yes ./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared ${GLIB_ICONV} && make install"
...
CARES_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared && make install"
...
CURL_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared --enable-ares --with-ssl --with-zlib --without-random --disable-file --disable-ldap --disable-ldaps --disable-rtsp --disable-telnet --disable-tftp --disable-pop3 --disable-imap --disable-smtp --disable-manual --disable-dict && make install"
...
BZIP_COMMANDS="make CC=\"$CC\" AR=\"$AR\" RANLIB=\"$RANLIB\" LDFLAGS=\"$LDFLAGS\" CFLAGS=\"$CFLAGS\" PREFIX=\"$PREFIX\" install"
...
EXPAT_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared && make install"
...
FREETYPE_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared && make install"
...
FONTCONFIG_COMMANDS="./autogen.sh --prefix=$PREFIX --host=$HOST --build=$BUILD --with-arch=$ARCH --disable-shared --with-freetype-config=\"$PREFIX/bin/freetype-config\" && make install"
...
PIXMAN_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared --disable-gtk && make install"
...
PNG_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared && make install"
...
CAIRO_COMMANDS="CFLAGS=\"${CFLAGS} -DPNG_SKIP_SETJMP_CHECK=1\" ./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared --disable-xlib --disable-ps --disable-pdf --disable-svg && make install"
...
PANGO_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --without-x --disable-shared --with-included-modules=yes && make install"
...
JPEG_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared && make install"
...
TIFF_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared && make install"
...
GIF_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared && make install"
...
JSON_COMMANDS="./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared --disable-glibtest && make install"
JSON_DEPENDS="GLIB"
...
CLUTTER_COMMANDS="ac_cv_lib_GLES_CM_eglInitialize=yes ac_cv_func_malloc_0_nonnull=yes ./configure --prefix=$PREFIX --host=$HOST --build=$BUILD --disable-shared --with-flavour=eglnative --with-gles=${GLES} --with-imagebackend=internal && make install" 
...
AVAHI_COMMANDS="./configure --host=$HOST --prefix=$PREFIX --build=$BUILD --disable-shared --disable-qt3 --disable-qt4 --disable-gtk --disable-dbus --disable-gdbm --disable-libdaemon --disable-python --disable-pygtk --disable-python-dbus --disable-mono --disable-monodoc --disable-autoipd --disable-doxygen-doc --disable-doxygen-dot --disable-doxygen-xml --with-distro=none --disable-nls --disable-shared && make install"
AVAHI_DEPENDS="GLIB"
...
UPNP_COMMANDS="./configure --host=$HOST --prefix=$PREFIX --build=$BUILD --disable-shared && make && make install"
...
URI_COMMANDS="./configure --host=$HOST --prefix=$PREFIX --build=$BUILD --disable-shared --disable-test --disable-doc && make && make install"
...
UUID_COMMANDS="sed -i \"s/-c -s -m/-c -m/\" Makefile.in && ac_cv_va_copy=no ./configure --host=$HOST --prefix=$PREFIX --build=$BUILD --includedir=$PREFIX/include/ossp --disable-shared && make && make install"
