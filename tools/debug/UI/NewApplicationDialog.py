...
#
# Created: Wed Feb 29 16:46:07 2012
...
class Ui_newApplicationDialog(object):
    def setupUi(self, newApplicationDialog):
        ...
        newApplicationDialog.resize(465, 156)
        font = QtGui.QFont()
    ...
    def retranslateUi(self, newApplicationDialog):
        ...
        self.labelDirectory.setText(QtGui.QApplication.translate("newApplicationDialog", "Directory", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.labelId.setText(QtGui.QApplication.translate("newApplicationDialog", "ID", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.labelName.setText(QtGui.QApplication.translate("newApplicationDialog", "Name", None, QtGui.QApplication.UnicodeUTF8))
