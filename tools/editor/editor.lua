...
function editor.inspector(v, x_pos, y_pos, scroll_y_pos, org_items)
	...
	for i=1, #attr_t do 
		...
		elseif attr_n == "items" or attr_n ==  "tab_labels" then 
			...
			elseif attr_n == "reactive" or attr_n == "loop" or attr_n == "vert_bar_visible" or attr_n == "horz_bar_visible" or attr_n == "cells_focusable"  or attr_n == "lock" or attr_n == "show_ring" or attr_n == "justify" or attr_n == "single_line" or attr_n == "arrows_visible" then  -- Attribute with single checkbox
