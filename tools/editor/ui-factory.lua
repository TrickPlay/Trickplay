...
function factory.make_text_input_item(assets, inspector, v, item_n, item_v, item_s, save_items, old_inspector) 
	...
	local non_textInput_items = {"line", "button", "focus", "tab_labels", "items", "skin", "wrap_mode", 
