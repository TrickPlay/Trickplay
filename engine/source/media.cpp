...
int Media::get_viewport_geometry( int* left, int* top, int* width, int* height )
{
    MPLOCK;
...
int Media::set_viewport_geometry( int left, int top, int width, int height )
{
    MPLOCK;
...
int Media::reset_viewport_geometry( )
{
    gfloat width;
    gfloat height;
