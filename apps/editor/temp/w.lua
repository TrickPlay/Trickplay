...
function widget.button(t) 
 ...
 --default parameters
    ...
    local button_map = 
    {
    ["text"] = function() text.text = v text.position = { (p.width  -text.w)/2, (p.height - text.h)/2} p.text = v end, 
    ["bsize"] = function() p.width = v[1] p.height = v[2] redraw_ring() end, 
    ["bwidth"]= function()  p.width = v redraw_ring() end, 
    ["bw"] = function()  p.width = v redraw_ring() end, 
    ["bheight"] = function()  p.height = v redraw_ring() end, 
    ["bh"] = function()  p.height = v redraw_ring() end, 
    ["border_width"] = function()  p.border_width= v redraw_ring() end, 
    ["border_color"] = function()  p.border_color= v redraw_ring() end, 
    ["bc"] = function()  p.border_color= v redraw_ring() end, 
    ["focus_color"] = function()  p.focus_color= v redraw_ring() end, 
    ["fc"] = function()  p.focus_color= v redraw_ring() end, 
    ["padding_x"] = function()  p.padding_x = v redraw_ring() end, 
    ["padding_y"] = function()  p.padding_y = v redraw_ring() end, 
    ["border_radius"] = function()  p.border_radius = v redraw_ring() end, 
    ["font"] = function()  p.font = v text:set{font = v} end, 
    ["color"] = function()  p.color = v text:set{color = v} end, 
    ["button_image"] = function()  p.button_image = assets(v)
       group:remove(group:find_child("button"))  
       button = p.button_image
       button:set{name="button", position = {0,0} , size = { p.width , p.height }}
       if p.skin == "ring_image" or p.skin == "image" then
	    button.opacity = 255
       else 
	    button.opacity = 0
       end 
       group:add(button)
       group:find_child("text"):raise_to_top() end, 
...
--[[
    ...
    elseif k == "bsize" then return {p.width, p.height}  
    ...
    elseif (k == "btype" or k =="skin") then return p.skin 
    end 
]]
...
function widget.buttonPicker(t)
     ...
     local unfocus = assets("assets/smallbutton.png")
	   unfocus:set{ position = {pos[1], pos[2]}, size = {p.width, p.height}, opacity = 255}
--anchor_point = {unfocus.w/2,unfocus.h/2}, position = {pos[1], pos[2]}, opacity = 255}
     local focus = assets("assets/smallbuttonfocus.png")
	   focus:set{ position = {pos[1], pos[2]}, size = {p.width, p.height}, opacity = 0}
...
function widget.radioButton(t)
	...
	make_radioButton() 
     elseif (k == "skin" or k == "btype" or k == "b_type") then 
        p.b_type = v
        make_radioButton() 
     elseif k == "items" then 
	p.items = v
	...
	rButton.extra.selected = p.selected_item
     ...
     elseif k == "skin" or k == "b_type" or k == "btype" then return p.b_type 
     elseif k == "bsize" then return {p.width, p.height}
     elseif (k == "bwidth" or k == "bw") then return p.width
     elseif (k == "bheight" or k == "bh") then return p.height 
...
function widget.checkBox(t)
    ...
    local  cBox = Group {
     ...
     if (k == "skin" or k == "btype" or k == "b_type") then 
        p.b_type = v
        make_checkBox() 
     elseif k == "items" then 
	p.items = v
