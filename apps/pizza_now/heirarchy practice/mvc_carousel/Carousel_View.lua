CarouselView = Class(View, function(view, model, ...)
    view._base.init(view,model)

    view.menu_items = { Image{src="mvc_carousel/match.png", scale={.7,.7}, y=-50  },
                        Image{src="mvc_carousel/match.png", scale={.7,.7}, y=-50  },
                        Image{src="mvc_carousel/match.png", scale={.7,.7}, y=-50  },
                        Image{src="mvc_carousel/match.png", scale={.7,.7}, y=-50  },
                        Image{src="mvc_carousel/match.png", scale={.7,.7}, y=-50  }
    }

    view.ui = Group{name="carousel_ui", position={1,1}, opacity=255}
...
---------------------------------------------------------
    ...
    function view:initialize()
        self:set_controller(CarouselController(self))
    end
