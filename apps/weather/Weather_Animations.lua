...
conditions = {
    ["Chance of Flurries"]       = function() set_states{chance_of="FLURRIES"} end,
    ["Chance of Rain"]           = function() set_states{chance_of="RAIN"     }end,
    ["Chance of Freezing Rain"]  = function() set_states{chance_of="F_RAIN"} end,
    ["Chance of Sleet"]          = function() set_states{chance_of="SLEET"} end,
    ["Chance of Snow"]           = function() set_states{chance_of="SNOW"} end,
    ["Chance of Thunderstorms"]  = function() set_states{chance_of="TSTORMS"} end,
