...
function self:create(p)
    ...
    --Visual Components
    local text = Text{ text   = p.text, font = font, color = "000000", x = 15, y = 3 }
    ...
    local meta_setters = {
        ...
        state      = function(v) if v == "EXPAND" then if  p.slider then p.slider:animate{duration = 100,opacity = 255} end p.contents:grab_key_focus() elseif v == "CONTRACT" and p.slider then p.slider:animate{duration = 100,opacity = 0} end anim_state.state = v end,
