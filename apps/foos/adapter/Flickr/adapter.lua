...
print(i,user_ids[i])
	...
	local request = URLRequest {
		url = "http://www.flickr.com/services/rest/?method=flickr.people.getPublicPhotos&format=json&api_key=e68b53548e8e6a71565a1385dc99429f&user_id="..user_ids[#adapters+1-model.fp_1D_index].."&nojsoncallback=1",
