...
--]]
            ...
            if model.albums[prev_i[1]][prev_i[2]] == nil then
                print("leaving placeholder")
                model.placeholders[prev_i[1]][prev_i[2]]:complete_animation()
                model.placeholders[prev_i[1]][prev_i[2]]:animate{
                     duration = CHANGE_VIEW_TIME,
                     scale    = {
                     ...
                     position = {
                         screen.width  * (prev_i[2]-1) / (NUM_VIS_COLS + 1),
                         screen.height * (prev_i[1]-1) / NUM_ROWS
                     },
                     ...
                     on_completed = function()
                         ...
                         if model.albums[sel[1]] == nil or 
                            model.albums[sel[1]][sel[2]] == nil then
                             ...
                             print("completed, moving to cover")
                ...
                print("leaving cover")
                model.albums[prev_i[1]][prev_i[2]]:complete_animation()
                model.albums[prev_i[1]][prev_i[2]]:animate{
                    duration = CHANGE_VIEW_TIME,
                    scale    = {
                        (screen.width/(NUM_VIS_COLS+1))  / 
