local robot = {
		mainMenuBackground = "",
		creeps = {
			normalCreep = { hp = 2000, creepType = "assets/normalRobot.jpg", speed = 30, bounty = 10,flying = false},
			mediumCreep = { hp = 5000, creepType = "assets/mediumRobot.jpg", speed = 50, bounty = 15, flying = false}
		},
		towers = {
