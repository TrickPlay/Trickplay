local robot = {
		...
		creeps = {
			...
			{ hp = 300, speed = 30, bounty = 15, flying = false, frames = 7,  x_offset = -SP/2, y_offset = -SP, name = "MediumCreep"},
                        { hp = 1000, speed = 25, bounty = 20, flying = false, frames = 7,  x_offset = -SP/2, y_offset = -SP, name = "HardCreep"},
