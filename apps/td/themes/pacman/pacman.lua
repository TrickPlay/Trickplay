local pacman = {
		...
		towers = {
				normalTower =
						{ damage = 2, range = 800, cooldown = 0.5, cost = 50, slow = false, splash = false, frames = 1, name = "NormalTower", bullet = 2, mode = "rotate",
								upgrades =   	{
				...
				slowTower =
						{ damage = 5, range = 400, cooldown = 1, cost = 80, slowammount = 75, slow = true, splash = true, frames = 1, splashradius = 240, name = "SlowTower", mode = "rotate",
								upgrades =      {
				...
				nukeTower =
						{ damage = 30, range = 200, cooldown = 2, cost = 500, slowammount = 100, slow = true, splash = true, frames = 1, splashradius = 360, name = "NukeTower", attackFrames = 5,
				attackMode = "fire", damageAroundSelf = true,
						},
				wall =
