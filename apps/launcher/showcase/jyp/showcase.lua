...
local function IdleFunctionTimeline( props )
    ...
    function mt.start( props )
        ...
        local interval = props.interval
        local functions = props.functions
...
function( ui )
    ...
    local function build_ui()
        ...
        local image = Image{ src = "showcase/jyp/assets/background.jpg" }
        ...
        local lights =
        {
            Image{ src = "showcase/jyp/assets/background_lights_01.jpg" },
            Image{ src = "showcase/jyp/assets/background_lights_02.jpg" },
            Image{ src = "showcase/jyp/assets/background_lights_03.jpg" },
            Image{ src = "showcase/jyp/assets/background_lights_04.jpg" },
            Image{ src = "showcase/jyp/assets/background_lights_05.jpg" },
        }
        ...
        group = Group
        {
            ...
            children =
            {
                ...
                Image
                {
                    src = "showcase/jyp/assets/logo.png",
                    x = 40,
                    y = 160
                },
                photo_group
        ...
        local function make_photo_tile( src )
            ...
            local frame = assets( "showcase/jyp/assets/frame.png" )
            local focus = assets( "showcase/jyp/assets/frame_focus.png" )
        ...
        local photos =
        {
            make_photo_tile( "showcase/jyp/assets/pictures/jypark1.jpg" ),
            make_photo_tile( "showcase/jyp/assets/pictures/jypark2.jpg" ),
            make_photo_tile( "showcase/jyp/assets/pictures/jypark3.jpg" ),
            make_photo_tile( "showcase/jyp/assets/pictures/jypark4.jpg" ),
            make_photo_tile( "showcase/jyp/assets/pictures/jypark6.jpg" ),
            make_photo_tile( "showcase/jyp/assets/pictures/jypark7.jpg" )
        }
...
--            photos[ front_photo ]:on_focus_in()
    ...
    local function play_video()
        ...
        if mediaplayer:load( "showcase/jyp/assets/video.mp4" ) ~= 0 then
