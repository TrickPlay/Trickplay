...
function myAppsHL:create(p)
    ...
    local sub_menu_edge = Clone{ name = "sub_menu_edge", source = sub_menu_edge }
    local sub_menu_bg   = Clone{ name = "sub_menu_bg",   source = sub_menu_bg,  x = sub_menu_edge.w   }
    ...
    sub_menu:add( sub_menu_edge, sub_menu_bg, arrow )
