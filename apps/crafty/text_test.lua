...
text_test.extra.start = function()
    ...
    idle:add_onidle_listener(function()
        if(expand) then
            ...
            if(expandwidth == 640) then
                expand = false
            end
        else
            expandwidth = expandwidth - 1
            if(expandwidth == 320) then
                expand = true
            end
        end
        ...
        border3.width = (1920-(expandwidth*2))              textblock3.width = (1920-(expandwidth*2))-2
        border3.x = expandwidth                             textblock3.x = expandwidth+1

        border4.width = expandwidth                         textblock4.width = expandwidth-2
        border4.x = (1920-expandwidth)                      textblock4.x = (1920-expandwidth)+1
        border5.width = expandwidth                         textblock5.width = expandwidth-2
        border5.x = (1920-expandwidth)                      textblock5.x = (1920-expandwidth)+1
    end)
end
