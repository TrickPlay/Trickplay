                   ...
                   lvl1txt    =     {
                                speed = 40,
                                text = Clone{ source = assets.level1 },
...
---[[
			...
			{y =  400, item = formations.row_fly_in_right, params = {         }},
			{y =  550, item = formations.loop_from_left,   params = {         }},
			{y =  800, item = formations.loop_from_right,  params = {         }},
			{y = 1200, item = formations.loop_from_left,   params = {         }},
			{y = 1200, item = formations.loop_from_right,  params = {         }},

			{y = 1600, item = formations.row_fly_in_left,  params = {-100, 100}},
			{y = 1660, item = formations.row_fly_in_left,  params = {-100, 300}},
			{y = 1660, item = formations.loop_from_right,  params = {         }},
			{y = 1720, item = formations.row_fly_in_left,  params = {-100, 500}},
			--{y = 1720, item = formations.loop_from_right,params = {           }},
			{y = 1780, item = formations.row_fly_in_left,  params = {-100, 700}},
			--{y = 1840, item = formations.loop_from_left,params = {}},

			{y = 2000, item = formations.row_fly_in_left,  params = {  50, 700}},
			{y = 2000, item = formations.loop_from_left,   params = {         }},
			--]]
			{y = 0, item = formations.zepp,             params = { 150,-400, true}},	
		...
		--   y_pos          asset#  x_pos x_rot y_rot z_rot
			...
			{y =    0, params = {2, 1620, 0, 180, 0}},

			{y =  180, params = {1,  200,   0, 180,   50}},
			{y =  220, params = {3,  800, 180, 180,   50}},
			{y =  280, params = {3,  600,   0,   0,  170}},
