...
--[[
    ...
    THIS IS A GROSS HACK OF LAUNCHER FOR A SINGLE PURPOSE, DO NOT EXPECT MUCH
...
local function build_ui( show_it )
    ...
    local function dummy()
        return Rectangle{ color = { 0 , 0 , 0 , 0 } , size = { 1 , 1 } }
    end
    ...
    local ui =
    {
        ...
        bar_background      = dummy(), --assets( "assets/menu-background.png" ),
        
        button_focus        = dummy(), --assets( "assets/button-focus.png" ),
        
        search_button       = dummy(), --assets( "assets/button-search.png" ),
        
        search_focus        = dummy(), --assets( "assets/button-search-focus.png" ),
        
        logo                = dummy(), --assets( "assets/logo.png" ),
                
        sections =
        {
            [SECTION_APPS] =
            {
                button  = dummy(), -- assets( "assets/button-red.png" ),
                text    = dummy(), --Text  { text = strings[ "My Apps" ] }:set( BUTTON_TEXT_STYLE ),
                color   = { 120 ,  21 ,  21 , 230 }, -- RED
                height  = 900 - 60 - 30  ,
                init    = nil, --dofile( "section-apps" )
            },
            
            [SECTION_SHOWCASE] =
            {
                button  = dummy(), --assets( "assets/button-green.png" ),
                text    = dummy(), --Text  { text = strings[ "Showcase" ] }:set( BUTTON_TEXT_STYLE ),
                color   = {   5 ,  72 ,  18 , 230 }, -- GREEN
                height  = 890,
                init    = nil, --dofile( "section-showcase" )
            },

            [SECTION_SHOP] =
            {
                button  = dummy(), --assets( "assets/button-yellow.png" ),
                text    = dummy(), --Text  { text = strings[ "App Shop" ] }:set( BUTTON_TEXT_STYLE ),
            ...
            [SECTION_SETTINGS] =
            {
                button  = dummy(), --assets( "assets/button-blue.png" ),
                text    = dummy(), --Text  { text = strings[ "More" ] }:set( BUTTON_TEXT_STYLE ),
                color   = {  24 ,  67 ,  72 , 230 },  -- BLUE
                height  = 380,
                init    = nil, -- dofile( "section-settings" )
            }
        }
    }
    ...
    for sn , section in ipairs( ui.sections ) do
        ...
        section.dropdown_bg = Rectangle{ color = { 0 , 0 , 0 , 0 } , size = { 1 , 1 } }
    ...
    ui.focus = SECTION_SHOP         -- The section # that has focus
    ...
    function ui:go_to_shop()
        --ui.bar:hide()
        
        ui.focus = SECTION_SHOP
        
        local section = dofile( "fs-shop" )( ui )
...
--[[        
        ...
        print( ui.sections[ SECTION_SHOP ] )
        local section = ui.sections[ SECTION_SHOP ]
        dolater( 1000 , section.on_enter , section )
]]
...
--[[            
        ...
        ui.fs_focus = SECTION_SHOP
        dolater( enter_section )
]]        
    end
    ----------------------------------------------------------------------------
