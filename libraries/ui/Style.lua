...
ArrowStyle = function(parameters)
    ...
    elseif type(parameters) ~= "table" then
        error("ArrowStyle requires a table or nil as input",2)
    end
...
BorderStyle = function(parameters)
    ...
    if parameters == nil then
        parameters = {}
    elseif type(parameters) ~= "table" then
        error("BorderStyle requires a table or nil as input",2)
    end
...
TextStyle = function(parameters)
    ...
    if parameters == nil then
        parameters = {}
    elseif type(parameters) ~= "table" then
        error("TextStyle requires a table or nil as input",2)
    end
...
Style = function(parameters)
    ...
    if parameters == nil then
        parameters = {}
    elseif type(parameters) ~= "table" then
        error("Style requires a table or nil as input",2)
    end
