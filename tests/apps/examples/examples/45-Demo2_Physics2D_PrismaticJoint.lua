...
-- Static-frame stuff
	...
	gGround = Rectangle( {
						size     = { (gBox02.x + (gBox02.width / 2)) - (gBox01.x - (gBox01.width / 2)), 2 },
						color    = "AntiqueWhite",
	} )
	...
	gSideRight = Rectangle( {
						size     = { gSideLeft.width, gSideLeft.height },
						color    = "AntiqueWhite",
	} )
	...
	gTop = Rectangle( {
						size     = { gGround.width, gGround.height },
						color    = "AntiqueWhite",
	} )
