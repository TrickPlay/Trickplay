...
function generate_test_image ()
	...
	test_image:rotate (0)
	test_image:text_path ("DejaVu 30px","<b>This text is normal</b>")
	test_image:rotate (-90)
	test_image:text_path ("DejaVu 30px","<b>This text goes down</b>")  
	test_image:rotate (-90)
	test_image:text_path ("DejaVu 30px","<b>This text is upside-down</b>")
	test_image:rotate (-90)
	test_image:text_path ("DejaVu 30px","<b>This text goes up</b>")
	test_image:fill()
