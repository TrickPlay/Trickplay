...
function generate_test_image ()
	...
	test_image:rotate (0)
	test_image:text_path ("DejaVu 30px","This text is normal")
	test_image:rotate (90)
	test_image:text_path ("DejaVu 30px","This text goes down")  
	test_image:rotate (90)
	test_image:text_path ("DejaVu 30px","This text is upside-down")
	test_image:rotate (90)
	test_image:text_path ("DejaVu 30px","This text goes up")
	test_image:fill()
