...
function test_UIElement_image_on_hide ()
    assert_equal(on_hide_called, 4, "on_hide_called returned: ", on_hide_called, " Expected: 4")
end

-- Verify that on_show gets called 4 times
function test_UIElement_image_on_show ()
    assert_equal(on_show_called, 4, "on_show_called returned: ", on_show_called, " Expected: 4")
end
