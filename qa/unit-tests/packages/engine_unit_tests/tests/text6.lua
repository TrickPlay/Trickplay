...
function test_Text_properties_basic ()
	...
	assert_true (myText1.editable, "myText1.editable returned: ",myText1.editable, ". Expected: true")
	assert_equal (myText1.wrap_mode, "CHAR", "myText1.wrap_mode returned: ", myText1.wrap_mode, ". Expected: CHAR")
	assert_false (myText1.single_line, "myText1.single_line returned: ", myText1.single_line, ". Expected: false.")
	assert_true (myText1.wants_enter,  "myText1.wants_enter returned: ", myText1.wants_enter, ". Expected: true")
	...
	assert_true (myText1.justify, "justify1.text returned: ", myText1.justify, ". Expected: true.")
	...
	assert_true (myText1.cursor_visible, "myText1.cursor_visible returned: ", myText1.cursor_visible, ". Expected: true.")
