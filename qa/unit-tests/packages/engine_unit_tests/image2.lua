...
image1.async = false
image1.src = "packages/engine_unit_tests/assets/globe.png"
image1.position ={ 1500, 900 }
image1.size = { 100, 100}
test_group:add (image1)

-- Tile an image
image2.src = "packages/engine_unit_tests/assets/jack.jpg"
...
image3.async = true
image3.src = "packages/engine_unit_tests/assets/does_not_exist.png"
