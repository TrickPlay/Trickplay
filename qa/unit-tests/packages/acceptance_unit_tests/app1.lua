...
function test_app_basic ()
    assert_equal( app.id, "com.trickplay.editor", "app.id failed" )
    assert_equal( app.name, "TrickPlay", "app.name failed" )
   	assert_equal( app.release, 1, "app.release failed" ) 
    assert_equal( app.version, "1.0", "app.version failed" )
    assert_equal( app.author, "", "app.author failed" )
    assert_equal( app.copyright, "Trickplay Inc.", "app.copyright failed" )
 	assert_equal( app.description, "", "app.description failed" )
