...
function generate_match_image (resize_ratio_w, resize_ratio_h)
	...
	local t1 = Text{x = 10, y = 10, w = 310, h = 50, markup = "TrickPlay", color = "FF00FF", font = "Verdana 30px", use_markup = true}
	...
	local t2 = Text{x = 10, y = 100, w = 310, h = 200, markup = "That Sam-I-Am\nThat Sam-I-Am\nI do not like that Sam-I-Am", color = "00FFFF", font = "DeJa Vu 20px"}
