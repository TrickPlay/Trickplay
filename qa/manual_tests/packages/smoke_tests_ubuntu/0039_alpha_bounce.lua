-- Test Set up --
local test_description = "Alpha Bounce"
local test_group = "acceptance"
local test_area = "alpha"
local test_api = "bounce"
...
function generate_test_image ()
	...
	local alphaMode1 = "EASE_IN_BOUNCE"
...
-- EASE OUT BOUNCE --
	...
	-- *** SET DESIRED ALPHA MODE HERE ***
	local alphaMode2 = "EASE_OUT_BOUNCE"
	...
	-- *** SET DESIRED ALPHA MODE HERE ***
	local alphaMode3 = "EASE_IN_OUT_BOUNCE"
