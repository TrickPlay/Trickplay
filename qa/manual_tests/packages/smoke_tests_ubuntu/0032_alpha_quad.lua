-- Test Set up --
local test_description = "Alpha Quad."
local test_group = "acceptance"
local test_area = "alpha"
local test_api = "quad"

test_question = "test_question = Match the 3 alpha movements on the right with the charts on the left."
...
-- EASE OUT QUAD --
	...
	-- *** SET DESIRED ALPHA MODE HERE ***
	local alphaMode2 = "EASE_OUT_QUAD"
	...
	-- *** SET DESIRED ALPHA MODE HERE ***
	local alphaMode3 = "EASE_IN_OUT_QUAD"
