-- Test Set up --
local test_description = "Animate the opacity using animatorState"
local test_group = "acceptance"
local test_area = "animatorState"
local test_api = "opacity"

test_question = "Does the red rectangle decrease in opacity as it approaches the blue rectangle?"
