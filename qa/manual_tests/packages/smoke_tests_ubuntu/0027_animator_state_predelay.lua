-- Test Set up --
local test_description = "Animate a rectangle using animatorState with pre delay set to 1/2 of 4 seconds."
local test_group = "acceptance"
local test_area = "animatorState"
local test_api = "predelay"

test_question = "Does the white rectangle start moving when the red rectangle is halfway but arrive at the same time?"
...
local rect2 = Rectangle {
	...
	transitions = {
	{
		...
		target = "first",             
   	  	duration = 4000, 
       	keys = { 
		 { rect2, "position", "LINEAR", {600 ,700}, 0.5, 0}
		}
	},
	{
		source = "first", 
		target = "second",             
   	  	duration = 4000, 
       	keys = { 
		 { rect2, "position", "LINEAR", {200 ,700}, 0.5, 0}
		}
	},
	{
		source = "second", 
		target = "third",             
   	  	duration = 4000, 
       	keys = { 
		 { rect2, "position", "LINEAR", {200 ,700}, 0, 0}
		}
	}
}
}
