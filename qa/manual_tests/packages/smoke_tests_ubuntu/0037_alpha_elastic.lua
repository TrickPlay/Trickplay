-- Test Set up --
local test_description = "Alpha Elastic"
local test_group = "acceptance"
local test_area = "alpha"
local test_api = "elastic"
...
function generate_test_image ()
	...
	local alphaMode1 = "EASE_IN_ELASTIC"
...
-- EASE OUT ELASTIC --
	...
	-- *** SET DESIRED ALPHA MODE HERE ***
	local alphaMode2 = "EASE_OUT_ELASTIC"
	...
	-- *** SET DESIRED ALPHA MODE HERE ***
	local alphaMode3 = "EASE_IN_OUT_ELASTIC"
